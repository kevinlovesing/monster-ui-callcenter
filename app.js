define(function(require) {
	...
	var app = {
		...
		requests: {
			...
			'queues.get_livestats': {
				'url': 'accounts/{account_id}/queues/stats',
				'verb': 'GET'
			},
			'agents.get': {
				'url': 'accounts/{account_id}/agents',
				'verb': 'GET'
			},
			'agents.get_livestats': {
				'url': 'accounts/{account_id}/agents/stats',
				'verb': 'GET'
			},
			'agents.get_status': {
				'url': 'accounts/{account_id}/agents/status',
				'verb': 'GET'
			}
		},
      ...
      //Reinitializing previous data;
		...
		format_data: function(data) {
			...
			$.each(data.queues.data, function(k, v) {
